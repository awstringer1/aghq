...
opt_sparsetrust <- optimize_theta(funlist2d,c(1.5,1.5))
opt_trust <- optimize_theta(funlist2d,c(1.5,1.5),control = list(method = "trust"))
opt_bfgs <- optimize_theta(funlist2d,c(1.5,1.5),control = list(method = "BFGS"))